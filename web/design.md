...
| Componente | Papel |
| --- | --- |
| `PostComposer` | Formulário de criação: campos, fila de mídia reordenável, dicas, preview ao vivo, rascunho. |
...
- **Motion**: entradas de lista com stagger sutil (`delay: i*0.015`, teto 0.3s); troca de view com
  fade+slide de 150ms (`AnimatePresence mode="wait"`); itens da fila de mídia com `layout`.
